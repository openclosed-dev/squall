...
record RecordType<T extends Record>(
    Class<T> recordClass,
    Set<String> componentNames,
    Constructor<T> constructor,
    Map<String, Object> defaulValueMap) {

    static <T extends Record> RecordType<T> of(Class<T> recordClass) {
        try {
    ...
    T newInstance(Object... args) throws ReflectiveOperationException {
